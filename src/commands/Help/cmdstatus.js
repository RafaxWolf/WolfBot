...
execute (client, message, args){
  ...
  .addFields(
    ...
    { name: ":green_circle: Sistema de **Música**", value: "\`Activo\`", inline: true },
    ...
    { name: ":red_circle: Sistema de **Hacking**", value: "\`Desactivado\`", inline: true },
    { name: ":red_circle: Sistema de **Workshop**", value: "\`Desactivado\`", inline: true },
  )
