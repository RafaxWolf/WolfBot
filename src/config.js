const { TOKEN, CLIENTID, GUILD, VERIFICATION_CHANNEL, MONGODB_USER, MONGODB_PASSWD, GENIUS_API_KEY, TERMS_CHANNEL } = process.env;
...
if (!TOKEN || !CLIENTID) {
    console.error(chalk.red("❌ | Token o Client ID Faltantes. Por favor, revisa tu archivo .env y asegúrate de que las variables TOKEN y CLIENTID estén definidas."));
    process.exit(1);
}
...
module.exports = {
    TOKEN, CLIENTID, GUILD, VERIFICATION_CHANNEL, TERMS_CHANNEL, MONGODB_USER, MONGODB_PASSWD, GENIUS_API_KEY
};